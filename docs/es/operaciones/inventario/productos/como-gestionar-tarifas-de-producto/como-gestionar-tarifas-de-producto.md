...
<figure markdown="span">
  ...
  <figcaption>Pestaña Precio con las listas de precios de venta del producto. El mecanismo es el mismo al cambiar el selector a Compra.</figcaption>
</figure>

## Agrega una tarifa

Haz clic en **+ Añadir nueva tarifa** y, en el desplegable, elige una tarifa existente o selecciona **+ Crear tarifa** para dar de alta una nueva. Después completa:
...
## Edita o quita un precio asignado

Para editar, modifica el **Precio unitario** o el **Precio de lista** de una fila ya cargada. Para quitarlo, pasa el cursor sobre la fila y haz clic en el ícono de papelera que aparece: esto elimina el precio que el producto tiene asignado en esa tarifa, no la tarifa en sí.
