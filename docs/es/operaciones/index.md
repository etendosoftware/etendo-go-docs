...
-   :material-plus-box-outline:{ .lg .middle } **Crear un producto**
...
-   :material-shape-outline:{ .lg .middle } **Crear y configurar una categoría de producto**
    ...
    [:octicons-arrow-right-24: Leer más](inventario/productos/crear-una-categoria-de-producto/crear-una-categoria-de-producto.md)

-   :material-pencil-outline:{ .lg .middle } **Editar o eliminar un producto**

    ---

    Modifica los datos de un producto existente o dalo de baja.

    [:octicons-arrow-right-24: Leer más](inventario/productos/editar-o-eliminar-un-producto/editar-o-eliminar-un-producto.md)

-   :material-currency-usd:{ .lg .middle } **Gestionar tarifas de producto**

    ---

    Administra los precios de tus productos en cada tarifa.

    [:octicons-arrow-right-24: Leer más](inventario/productos/gestionar-tarifas-de-producto/gestionar-tarifas-de-producto.md)
...
-   :material-plus-box-outline:{ .lg .middle } **Crear un almacén**
