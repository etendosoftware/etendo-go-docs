...
- Prerrequisitos: ninguno. Es habitualmente el primer paso dentro de Tesorería.
...
> _Pendiente de confirmación manual: no se completó una autenticación real contra un banco en esta pasada — confirmar qué datos trae la sincronización inicial (rango de fechas, saldo) y si el usuario puede elegir la cuenta específica dentro de un mismo banco._
...
> _Pendiente de confirmación manual: no se encontró en el producto un campo de "saldo inicial" ni una acción explícita para marcar una cuenta como predeterminada. Confirmar si estas funciones existen bajo otro nombre o si no aplican a esta versión de Etendo Go._
