...
3. Haz clic en **Desconciliar (1)**.
    ...
    ![Filtro Conciliadas con un movimiento conciliado seleccionado y el botón Desconciliar (1) disponible](assets/como-conciliar-o-desconciliar-movimientos-contra-documentos-2.png)
