...
4. Si el cliente tiene **saldo a favor** (de cobros de más en otras facturas) o **crédito** disponible (anticipos ya registrados), el popup muestra la sección **Saldo a favor y crédito disponible**, con un listado de esos importes y su fecha. Puedes tildar uno o varios para aplicarlos a esta factura, en lugar de — o adicionalmente a — un cobro en efectivo/banco nuevo:
...
5. Haz clic en **Guardar** para registrar el cobro sin cerrar el popup, o en **Confirmar** para registrarlo y cerrar. El sistema actualiza automáticamente el importe **Pendiente de pago** en el panel lateral:

    ![Confirmación del pago registrado con el importe pendiente actualizado](pago-2.png)
