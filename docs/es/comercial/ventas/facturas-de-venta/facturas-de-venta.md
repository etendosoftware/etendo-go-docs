...
- **Confirmar** — confirma la factura y la pasa a estado Completado. La acción es directa, sin popup de confirmación.
- **Copia** — clona la factura actual creando un nuevo borrador con el mismo contacto, líneas y condiciones.
- **Enviar / Descargar** — abre el panel de envío por correo electrónico o descarga el PDF.
...
![Panel de añadir pago de la Factura de venta](pago-2.png)
