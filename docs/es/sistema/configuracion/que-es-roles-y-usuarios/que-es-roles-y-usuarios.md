---
title: ¿Qué es la sección Roles y usuarios?
description: >-
  Descubre para qué sirven los roles y usuarios en Etendo: cómo invitar a
  tu equipo, qué determina lo que cada uno ve y hace, y qué rol elegir.
tags:
  - Roles y usuarios
  - Usuarios
  - Sistema
...
<figure markdown="span">
  ![Ventana Roles de Etendo, con la cantidad de usuarios por rol y la tabla de acceso ventana por ventana para cada uno](assets/que-es-roles-y-usuarios-1.png)
